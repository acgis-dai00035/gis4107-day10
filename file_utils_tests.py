...
def test_get_file_content():
    ...
    file_name = "demo1.txt"
    expected = r"C:\acgis\gis4107_Intro2Prog\day10\lab\DysonDandAvneetK\data\demo1.txt does not exist"
    actual = get_file_content(file_name)
    print_test_results(get_file_content, expected, actual)
...
def test_write_to_file():
    ...
    content = '789'
    expected = '789'
    actual = write_to_file(file_name,content)
    print_test_results(write_to_file, expected, actual)
